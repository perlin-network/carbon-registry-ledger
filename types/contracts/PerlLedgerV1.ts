...
export declare namespace PerlLedgerV1 {
...
export interface PerlLedgerV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addCarbonTransfer"
      | "carbonTransfers"
...
export interface PerlLedgerV1 extends BaseContract {
  connect(runner?: ContractRunner | null): PerlLedgerV1;
  waitForDeployment(): Promise<this>;

  interface: PerlLedgerV1Interface;
  ...
  getCarbonTransfers: TypedContractMethod<
    [_serialNo: string],
    [PerlLedgerV1.CarbonTransferStructOutput[]],
    "view"
  >;
